 ...
 */
final class Version20181218213119 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_9474526CF675F31B ON comment (author_id)');
        $this->addSql('CREATE INDEX IDX_9474526CA77FBEAF ON comment (blog_post_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, password, password_change_timestamp, fullname, name, email, roles FROM user');
        ...
        $this->addSql('INSERT INTO user (id, username, password, password_change_timestamp, fullname, name, email, roles) SELECT id, username, password, password_change_timestamp, fullname, name, email, roles FROM __temp__user');
